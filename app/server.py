...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "server executes bounded public search, deduplication and website inspection only when "
        ...
        "Autopilot defaults to SAFE: it synchronizes state but does not autonomously discover "
        "companies. It never analyzes, scores, drafts, sends, or creates follow-ups. "
